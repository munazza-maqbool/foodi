...
public class ChefRegisteration extends AppCompatActivity {
    String[] State = {"Punjab","Sindh"};
    String[] Gujarat = {"Ahemdabad", "Rajkot", "Surat"};
    String[] Punjab = {"Lahore","Multan","Rawalpindi","Sialkot","Gujranwala"};

    String[] Sindh = {"karachi","sukkur","khairpur","thatta"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("State")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : State) {
                        list.add(text);
                    }
